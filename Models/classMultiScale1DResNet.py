...
class MSResNet(nn.Module):
    def __init__(self, input_channel, output_type, output_shape, layers=[1, 1, 1, 1]):
        self.inplanes3 = 64
        self.inplanes5 = 64
        self.inplanes7 = 64
        ...
        self.maxpool5 = nn.AvgPool1d(kernel_size=16, stride=1, padding=0)
        ...
        self.maxpool7 = nn.AvgPool1d(kernel_size=16, stride=1, padding=0)
