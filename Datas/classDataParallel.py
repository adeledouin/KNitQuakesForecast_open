...
class DataParallel(Module):
    ...
    **scattered** on dim specified (default 0). tuple, list and dict types will
    ...
    def __init__(self, module, device_ids=None, output_device=None, dim=0):
        ...
        print('available', _get_all_device_indices())
        ...
        print('self_device_ids', self.device_ids)
        print('self_output_device', self.output_device)
        print('self_src_device_obj', self.src_device_obj)
